...
export class PongComponent extends React.Component<PongProps, PongState> {
  ...
  drawStaticItems = (p5: p5Types) => {
    ...
    p5.textSize(50);
    p5.text("Pong", (this.windowWidth - this.paddleWidth) / 2 - 100 , this.windowHeight - 40);
    p5.textSize(20);
    p5.text("Druk op ESC om naar het menu te gaan", (this.windowWidth - this.paddleWidth) / 2 - 62 , this.windowHeight - 20);
  }
